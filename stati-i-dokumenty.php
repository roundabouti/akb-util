<?php /* Template Name: stati-i-dokumenty */ ?>

<?php get_header(); ?>

<title>Статьи и документы - ООО Стандарт</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, статьи, утилизация" />
<meta name="description" content="Статьи по особенностям утилизации аккумуляторов и свинцового лома." />
                        ...
                        <div class="col-lg-12 px-4 pb-4 pt-3">
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-6">
                                    ...
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                        <p class="pt-0">Всё об утилизации аккумуляторов</p> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <br>
