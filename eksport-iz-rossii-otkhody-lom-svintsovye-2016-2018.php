<?php /* Template Name: eksport-iz-rossii-otkhody-lom-svintsovye-2016-2018 */ ?>

<?php get_header(); ?>


<title>Экспорт из России  «отходы лом свинцовые»  «2016 - 2018»</title>
<meta name="keywords" content="экспорт, акб, лом, автомобильный, свинец" />
<meta name="description" content="Экспорт из России товаров из группы «отходы лом свинцовые» за период 2016 - 2018 составил $10.1 тыс., общим весом 6.05 тонн." />
            ...
            <div class="col-12 ">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-3 my-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Экспорт из России  «отходы лом свинцовые»  «2016 - 2018»</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Экспорт свинца 2016-2018</h1>
                                    </div>
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                        <h2 class="text-danger-custom text-center text-xl-left">1. Сводная информация:</h2>
 
                                          
                                       <p class="pt-2"> Экспорт из России товаров из группы&nbsp;«отходы лом свинцовые»&nbsp;за период 2016 - 2018 составил&nbsp;$10.1 тыс., общим весом 6.05 тонн. В основном экспортировались&nbsp;«отходы лом свинцовые»&nbsp;(100%).</p>
<h2 class="text-danger-custom text-center text-xl-left">2. Общие итоги по годам
</h2>
