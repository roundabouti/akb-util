<?php /* Template Name: aktsii */ ?>

<?php get_header(); ?>


<title>Акции - ООО Стандарт</title>
<meta name="keywords" content="акции, стандарт, информация" />
<meta name="description" content="Акции компании ООО “Стандарт”" />
...
<li class="breadcrumb-item active" aria-current="page">Акции</li>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Акции</h1>
                                    </div>
                                    <hr class="m-0"/>
    ...
    <p class="pt-2">Действующих акций нет.</p>
                                </div>
