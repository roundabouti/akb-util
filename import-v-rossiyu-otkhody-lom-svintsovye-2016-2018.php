<?php /* Template Name: import-v-rossiyu-otkhody-lom-svintsovye-2016-2018 */ ?>

<?php get_header(); ?>


<title>Импорт в Россию «отходы лом свинцовые»  «2016 - 2018»</title>
<meta name="keywords" content="импорт, акб, лом, автомобильный, свинец" />
<meta name="description" content="Импорт в Россию товаров из группы «отходы лом свинцовые» за период 2016 - 2018" />
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Импорт свинца 2016-2018</h1>
                                    </div>
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                       ...
                                       <p class="pt-2">Импорт в Россию товаров из группы «отходы лом свинцовые» за период 2016 - 2018 составил $2.7 млн., общим весом 3.18 тыс. тонн.
В основном импортировались «отходы лом свинцовые» (100%).
В структуре импорта по странам (товаров из группы «отходы лом свинцовые») на первом месте Казахстан (91%), на втором месте Киргизия (9%).</p>
