<?php /* Template Name: posrednikam */ ?>

<?php get_header(); ?>



<title>Посредникам - ООО Стандарт</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, посредник, утилизация" />
<meta name="description" content="Прием акб у сборщиков лома. Если вы желаете зарабатывать деньги на сборе аккумуляторного лома, то все что вам нужно сделать - позвонить нам." />
                    ...
                    <div class="row h-100 justify-content-center bg-white shadow panel p-0 m-0">
                        <div class="col-12">
                            <div class="row text-left h-100 pb-0 align-items-center ">
                                ...
                                <div class="col-xl-4 px-4 pt-4 pb-xl-4 pr-xl-0">



                                    <div class="row panel m-0 px-2 bg-secondary-custom center d-flex justify-content-center">
                                        <div class="col-12 small p-3"><b>Если вы желаете зарабатывать деньги</b> на сборе аккумуляторного лома, то все что вам нужно сделать - позвонить нам.

                                        </div>
                                        <div class="col-12 small pt-2">
                                            Имея автомобиль и место для хранения аккумуляторов (или просто стоящий без дела грузовичек) вы можете начать бизнес вместе с нами. <br>
                                        </div>
                                        <div class="col-12 small pt-3"><b>Мы предлагаем:</b>
                                        </div>



                                        <div class="col-12 small pt-0">

                                            <ul class="red2">
                                                <li>Лучшие цены на аккумуляторный лом</li>
                                                <li>Вывоз лома своим транспортом</li>
                                                <li>Размещение рекламы на вашей машине</li>
                                                <li class="text-left">Размещение адреса и телефона вашей точки сбора у нас на сайте и на карте</li>
                                                <li>Лицензионная поддержка</li>
