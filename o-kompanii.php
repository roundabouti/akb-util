<?php /* Template Name: o-kompanii */ ?>

<?php get_header(); ?>


<title>Информация о компании ООО Стандарт - прием и утилизация аккумуляторов и свинцового лома</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, информация" />
<meta name="description" content="Список услуг, которые оказывает ООО “Стандарт”" />
...
<header class="sticky-top">
    ...
    <a class="dropdown-item">О компании</a>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">О компании</h1>
                                    </div>
                                    <hr class="m-0"/>
                                 
                                     <h3 class="text-danger-custom text-center text-xl-left">
         Услуги, которые оказывает ООО “Стандарт”:
    </h3>
    <ul class="red">
        <li>закупка Лома цветных металлов по ГОСТ 1639-2009 у юридических лиц принадлежащего им на праве собственности в соответствии с требованиями, указанных выше документов. По договору купли-продажи лома цветных металлов.</li>
        <li>покупка и утилизация опасных отходов по ФККО и БДО. По договору поставки опасных отходов с обязательством дальнейшей утилизации.</li>
    </ul>
     <h3 class="text-danger-custom text-center text-xl-left">
         Преимущества при работе с нами:
    </h3>
    <ol>
        <li>Дополнительный доход. Затраты на выполнение требований законов и законодательных актов в области защиты окружающей среды мы превращаем в Вашу выгоду.</li>
        <li>Полный пакет документов со всеми участниками сделки вплоть до утилизации.</li>
        <li>Окончательный расчет в течение 1-5 рабочих дней. Обычно мы платим день в день после получения счета, в крайнем случае, в течение 5 дней согласно пункту договора.</li>
        <li>Забор в течение 1-2 дней любых объемов после подписания договора или на условиях клиента. После договоренности машину отправляем день в день либо максимум 2 дня. Многие клиенты даже удивляются, когда слышат, что мы можем забрать «завтра».</li>
        <li>Точное Взвешивание на Поверенных весах. «Заряженные» весы целый бизнес в цветмете. Но мы делаем поверку раз в 3 месяца. Нам это не интересно. Репутация стоит дороже!</li>
        <li>Окончательная СТОИМОСТЬ 1 КГ без учета засора, зафиксированную в договоре. В большинстве случаев компании ставят засор на аккумуляторы (примерно 9-12%), обычно клиент узнает это на финальном этапе отгрузки и цена падает на 9-12%. Наша цена не поменяется после того, как ее согласовали.</li>
        <li>Удобный способ оплаты в соответствии с учетной политикой клиента.</li>
