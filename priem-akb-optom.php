<?php /* Template Name: priem-akb-optom */ ?>

<?php get_header(); ?>

<title>Сдать бу аккумуляторы оптом в Москве - Стандарт</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, опт, утилизация" />
<meta name="description" content="Продать оптом старые аккумуляторы дорого в Москве Вы можете в Стандарт. ✔Любая форма оплаты. ✔Прием б у АКБ по выгодной цене." />
            ...
            <div class="col-12 ">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-3 my-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Приём АКБ оптом</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Приём АКБ оптом</h1>
                                    </div>
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                        <p class="pt-2">Многие механизмы и агрегаты в автомобилях являются расходными материалами. В их числе аккумуляторы. Каждое устройство имеет свой срок службы, по истечении которого оно должно быть утилизировано. Хранить отработавшие свое батареи не рекомендуется, тем более – выкидывать их на свалку. Они содержат много материалов, которые наносят очень большой вред окружающей среде. Таковым является, в частности, свинец – очень токсичный металл. Чтобы не захламлять природу опасным мусором, и при этом неплохо заработать, можно сдать аккумуляторы оптом. </p>
 
<p class="pt-2">
    Если вас интересует, куда можно сдать автомобильное вторсырье по выгодной цене, то можете обратиться в нашу компанию.
</p>

<h4  class="text-danger-custom text-center text-xl-left">Преимущества компании:</h4>
 
<p class="pt-0">
    <ul>
        <li>мы работаем строго по закону, имеем все необходимые документы; </li>
        <li>
        нам продают разные объемы лома – от 1 кг до центнеров и тонн (мелкий и крупный опт); </li>
        <li>
        покупку мы можем оплатить любым удобным для клиента способом – наличными или по безналичному расчету; </li>
        <li>
        принимаем лом у организаций и частных лиц.</li>
    </ul>
 </p>
<p class="pt-2">
