...
<title>Новости - ООО Стандарт</title>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Новости</h1>
                                    </div>
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                        <p class="pt-2">В данном разделе вы сможете найти новости рынка свинца в России</p>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="pt-3 px-3 col-lg-6">
                                    <h6 class="text-danger-custom text-center text-xl-left"><a
                                            href="https://akb-util.ru/news/eksport-iz-rossii-otkhody-lom-svintsovye-2016-2018/">Экспорт из России «отходы лом свинцовые» «2016 - 2018»</a></h6>
                                        <hr>
                                        <h6 class="text-danger-custom text-center text-xl-left"><a
                                                href="https://akb-util.ru/services/priem-akb-ot-ibp/"></a></h6>
                                        <hr>
                                ...
                                <div class="pt-3 px-3 col-lg-6">
                                    <h6 class="text-danger-custom text-center text-xl-left"><a
                                            href="https://akb-util.ru/services/tsena-skupki/"> </a></h6>
                                    <hr>
                                    <h6 class="text-danger-custom text-center text-xl-left"><a
                                            href="https://akb-util.ru/services/vyvoz-akb/"> </a></h6>
                                    <hr>
                                </div>
