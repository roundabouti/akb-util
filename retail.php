<?php /* Template Name: retail */ ?>

<?php get_header(); ?>


<title>Прием бу аккумуляторов от частных лиц - ООО Стандарт</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, физлицо, утилизация" />
<meta name="description" content="Вывоз нашим транспортом производим от веса в 100 кг. Оплата сразу." />
    ...
    <div class="container bg-primary-custom p-0 scroll">
            ...
            <div class="col-12 ">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-3 my-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Частным лицам</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div data-aos="zoom-in-down" data-aos-duration="300">
            <div class="row w-100 ml-0 item">
                <div class="col-lg-12 pt-0 px-4 pb-4 pt-0 ">
