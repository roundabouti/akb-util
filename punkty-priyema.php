<?php /* Template Name: punkty-priyema */ ?>

<?php get_header(); ?>


<title>Пункты приёма бу аккумуляторов - ООО Стандарт</title>
<meta name="keywords" content="аккумулятор, акб, стандарт, пункт, утилизация" />
<meta name="description" content="На нашем сайте вы найдете все контактные данные" />
...
<li class="breadcrumb-item active" aria-current="page">Пункты приёма</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Пункты приёма аккумуляторов</h1>
                                    </div>
                                    <hr class="m-0"/>
                                    <div class="pl-0 pr-1">
                                        
                                        <p class="pt-2">В России каждый день увеличивается количество личных и служебных автомобилей. Постоянно появляются новые модели, с конвейеров каждый день сходят тысячи новых машин. Старая техника, вышедшая из строя, часто отправляется на свалку, либо просто ржавеет годами во дворах и гаражах. Но на таком автомобильном вторсырье можно хорошо заработать. Можно, к примеру, найти пункт приема аккумуляторов в Москве и сдать туда отработавшие свое и непригодные для дальнейшей эксплуатации АКБ.
    </p>
    <h2 class="text-danger-custom text-center text-xl-left">
    Пункт приема старых АКБ – ООО «Стандарт»
 </h2>
      <p class="pt-2">
         На нашем сайте вы найдете все контактные данные:
    </p>
   
 
        <ul class="red">
            <li><a href="https://akb-util.ru/contacts/">адреса, телефоны и график работы</a> стационарных подразделений компании;</li>
            <li>адреса и особенности приема мобильных пунктов;</li>
            <li>подробную карту Москвы с обозначением всех точек.</li>
        </ul>
   
 
      <p class="pt-2">
         На карте мы можете за несколько секунд найти ближайшее к вашему дому отделение компании, в котором можно сдать батарейки и другие виды лома.
    </p>
      <p class="pt-2">
         Кроме этого, каждый пользователь может оставить заявку, и менеджеры компании свяжутся с ним и обсудят все условия сотрудничества. Это актуально, например, для тех случаев, если у вас имеется очень большой объем вторсырья (больше 100 кг). Тогда ООО «Стандарт» организует вывоз его на своем транспорте.
    </p>
