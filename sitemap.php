            ...
            <div class="col-lg-12 px-3 pt-0 ">
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Карта сайта</h1>
                                    </div>
                                    <hr class="m-0"/>
                ...
                <div data-aos="zoom-in-down" data-aos-duration="300">
                    <div class="row w-100 ml-0 item">
                        <div class="col-lg-12 px-4 pb-4 pt-3">
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="pt-3 px-3 col-lg-12">
                                   <ul class="red">
                                       <li><a href="https://akb-util.ru/">Главная</a></li>
                                       <li><a href="https://akb-util.ru/retail/">Частным лицам</a></li>
                                       <li><a href="https://akb-util.ru/business/">Организациям</a></li>
                                       <li><a href="https://akb-util.ru/posrednikam/">Посредникам</a></li>
                                       <li><a href="https://akb-util.ru/pricing/">Цена</a></li>
