...
<title>Вакансии - ООО Стандарт</title>
<meta name="keywords" content="вакансии, стандарт, информация" />
<meta name="description" content="Список вакансий ООО “Стандарт”" />
...
<li class="breadcrumb-item active" aria-current="page">Вакансии</li>
                            ...
                            <div class="row h-100 bg-white shadow panel p-0 m-0">
                                <div class="p-3 col-lg-12">
                                    <div class="pl-0 pt-3 text-left">
                                        <h1 class="text-danger-custom text-center text-xl-left">Вакансии</h1>
                                    </div>
                                    <hr class="m-0"/>
    ...
    <p class="pt-2">Открытых вакансий нет.</p>
                                </div>
